namespace CSharpCodebyQuery
{
    class SelectSample2
    {
        ...
        public class Student
        {
            ...
            {
                ContactInfo cInfo =
                    (from ci in app.contactList where ci.ID == id select ci).FirstOrDefault();
                return cInfo;
            }
            ...
            public Student() { First = string.Empty; Last = string.Empty;  } 
        }
        ...
        public class ContactInfo
        {
            ...
            public ContactInfo() { Email = string.Empty; Phone = string.Empty; }
        }
